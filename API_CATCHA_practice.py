...
for city in citys:
    for weatherElement in weatherElements:
        ...
        df_export.to_excel(f"/Users/shijunliao/Desktop/Python/side_project/weather/weather_data/{city}/{weatherElement}.xlsx", index=False)
    print(f"{city} Done")
